<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <head>
        <meta charset="UTF-8">
        <title>Login UIS</title>
        <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:400,600,700" rel="stylesheet">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/meyer-reset/2.0/reset.min.css">
        <link rel="stylesheet" href="auth/loginstyle.css">

        <!-- Ẩn đi eye xem mật khẩu để chỉ dùng checkbox show-->
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                passwordInput.addEventListener("input", function () {
                    if (this.value.length > 0) {
                        this.type = "text";  // Đổi sang text để xóa icon con mắt
                        this.type = "password"; // Đổi lại về password ngay lập tức
                    }
                });
            });
    ...
    <body>
        ...
        <form>
            <!-- start tạo ảnh monster animation -->
            ...
            <!-- end tạo ảnh monster animation -->

            <!-- Start select role section -->
            <div class="inputGroup inputGroupRole">
            ...
            <div class="inputGroup inputGroupRemember">
        ...
        <script src="auth/loginscript.js"></script>
